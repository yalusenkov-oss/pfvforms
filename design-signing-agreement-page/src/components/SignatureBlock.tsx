    ...
    <>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-xl shadow-purple-100/20 overflow-hidden">
        ...
        <div className="p-6 sm:p-8 space-y-6">
          ...
          {isSigned ? (
            <button className="w-full py-4 rounded-xl text-base font-bold text-white bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 shadow-lg shadow-green-200/50 transition-all duration-200 flex items-center justify-center gap-2">
