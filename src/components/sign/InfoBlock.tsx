...
export function InfoBlock() {
  return (
    <div className="bg-gradient-to-r from-purple-50 to-purple-50/50 rounded-2xl border border-purple-100 p-4 sm:p-6">
      <div className="flex items-start gap-3">
        ...
        <div className="space-y-2">
          <p className="text-xs sm:text-sm font-semibold text-purple-900">ℹ️ Важная информация</p>
