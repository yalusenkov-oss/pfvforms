...
export function ContractDocument({ htmlContent }: ContractDocumentProps) {
  return (
    <div className="bg-white rounded-2xl border border-gray-100 shadow-xl shadow-purple-100/20 overflow-hidden flex flex-col h-full">
      <div className="px-4 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-purple-50 via-purple-50/60 to-transparent border-b border-gray-100 shrink-0">
        <div className="flex items-center gap-3">
          <FileText className="w-4 h-4 sm:w-5 sm:h-5 text-purple-600" />
          <h2 className="text-base sm:text-lg font-extrabold text-gray-900">📄 Документ договора</h2>
        </div>
      </div>
