...
export function ContractDocument({ htmlContent }: ContractDocumentProps) {
  return (
    <div className="bg-white rounded-2xl border border-gray-100 shadow-xl shadow-purple-100/20 overflow-hidden flex flex-col">
      ...
      <div className="p-4 sm:p-6 flex-1 min-h-0">
        <div
          className="contract-scroll max-h-[70vh] xl:max-h-[800px] overflow-y-auto border border-gray-200 rounded-lg bg-gray-50 p-4 sm:p-6"
