  ...
  const loadRemote = useCallback(async () => {
    ...
    try {
      ...
      const mapped = (Array.isArray(rows) ? rows : []).map((r: any, idx: number) => ({
        ...
        videoshot: normalizeBool(r.addVideoshot ?? r.videoshot),
        videoshotLink: r.videoshotLink || r.videoshot_link || '',
        videoshotPrice: normalizeNumber(r.videoshotPrice ?? r.videoshot_price),
